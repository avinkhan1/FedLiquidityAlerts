...
# Get the chart URL
$chartUrl = ('https://quickchart.io/chart-maker/view/{0}' -f $id)

# Save the chart URL to a text file
Set-Content -Path 'fed_liquidity.txt' -Value $chartUrl
...
# Save the chart URL to a text file
Set-Content -Path 'spx_fair_value.txt' -Value $chartUrl


# Convert the data to JSON
$jsonData = $table | ConvertTo-Json -Depth 100

# Write the JSON data to a file
Set-Content -Path 'liquidity_data.json' -Value $jsonData
